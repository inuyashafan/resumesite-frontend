    ...
    return (
        <nav className='flex items-center justify-between flex-wrap bg-blue-500 p-6'>
            <div className='flex items-center flex-shrink-0 text-black mr-6'>
                <Link to='/' className='font-semibold text-black text-xl tracking-tight'>Austin Safety Index</Link>
            </div>
            <div className='block'>
                <button onClick={dropDown} className='flex items-center px-3 py-2 text-teal-200 border rounded border-red-400 hover:text-white hover:border-white'>
            ...
            <div className='w-full block flex-grow items-center'>
                <div className="text-sm lg:flex-grow">
                    ...
                    <Button className='p-3 m-5 bg-red-400 justify-center'>
                        <div>
                            <Link to='/YourReports' onClick={ clicked} className='flex place-itmes-center mt-4 lg:inline-block lg:mt-0
                             text-teal-200 hover:text-white mr-4'>
                                Your Reports
                            </Link>
                        </div>
                    ...
                    <Button className='p-3 m-5 bg-red-400 justify-center'>
                        <div>
                            <Link to='/themap' onClick={ clicked} className='flex place-itmes-center mt-4 lg:inline-block lg:mt-0
                             text-teal-200 hover:text-white mr-4'>
                                The Map
                            </Link>
                        </div>
